...
The `home-routes` handler in the `filloca-sf.routes.home` namespace
...
The `home-page` function will in turn call the `filloca-sf.layout/render` function
...
The rest of this page is rendered by ClojureScript found in the `src/cljs/filloca_sf/core.cljs` file.



#### Organizing the routes

The routes are aggregated and wrapped with middleware in the `filloca-sf.handler` namespace:
...
Request middleware functions are located under the `filloca-sf.middleware` namespace.

This namespace is reserved for any custom middleware for the application. Some default middleware is
already defined here. The middleware is assembled in the `wrap-base` function.

Middleware used for development is placed in the `filloca-sf.dev-middleware` namespace found in
